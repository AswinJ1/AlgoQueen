      ...
      <div className="container mx-auto px-6 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex space-x-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            <a className="cursor-pointer text-gray-500 hover:text-algoqueen transition">
            ...
            <a className="cursor-pointer text-gray-500 hover:text-algoqueen transition" href="https://t.me/algoqueen2023" target="_blank" rel="noopener noreferrer">
