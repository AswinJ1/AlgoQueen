...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-1 sm:p-2", className)}
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-xs sm:text-sm focus-within:relative focus-within:z-20 flex-1 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
        ...
        day: cn(
          ...
          "h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 p-0 font-normal aria-selected:opacity-100"
        ),
